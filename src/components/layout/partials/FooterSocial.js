  ...
  return (
    ...
    >
      <ul className="list-reset">
        ...
        <li>
          <ReactGA.OutboundLink eventLabel="Footer Twitter Link" to="https://twitter.com/shrubfinance" target="_blank" rel='noopener noreferrer'>
          <a title="Follow Shrub.finance on Twitter">
