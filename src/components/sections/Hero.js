            ...
            <div className="container">
                <div className={innerClasses}>
                    <div className="hero-content" style={{marginTop: "20%"}}>
                        {/*opening*/}
                        {!isMobile && <h1 className="mt-0 mb-16 reveal-from-bottom jumbo feather" >
                            Your Crypto. Your Terms.
                        </h1>}

                        {(isMobile || isTablet) && <h1 className="mt-0 mb-16 reveal-from-bottom jumbo feather">
                        ...
                        <div className="container-xs" style={{marginTop: "10%"}}>
                            ...
                            {(isMobile || isTablet) && <p style={{paddingTop: "120px", fontWeight: "500", fontSize: "30px", lineHeight:"1.5"}}> Lending <br/>re<span
