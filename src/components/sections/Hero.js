...
const Hero = ({
            ...
            <div className="container">
                <div className={innerClasses}>
                    <div className="hero-content" style={{marginTop: "20%"}}>
                        {/*opening*/}
                        {!isMobile && <h1 className="mt-0 mb-16 jumbo feather">
                            Your Crypto. Your Terms.
                        </h1>}

                        {(isMobile || isTablet) && <h1 className="mt-0 mb-16 jumbo feather">
                        ...
                        <div className="container-xs" style={{marginTop: "10%"}}>
                            ...
                            {isMobile && !toggle &&
                                <Button className="search-button-mobile no-select" color="primary" wideMobile
                                        type="submit" onClick={handleSubmit}>
                                    Join the waitlist
                                </Button>}
    ...
    <path
        ...
        fill="#31FFA6"/>
                        ...
                        {!isMobile &&
                            <p style={{paddingTop: "180px", fontWeight: "500", fontSize: "40px"}}> Lending re<span
                                style={{position: "relative"}}>DeFi
                                <svg style={{position: "absolute", left: "0", bottom: "-8px"}} viewBox="0 0 180 22"
